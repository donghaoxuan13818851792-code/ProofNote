...
data, catches problems before they erase meaning, and exports either a
standalone presentation HTML document or a strict Editable HTML file that can
return to Proofnote for further editing.

**Local-first · Paper-first · LaTeX-safe · Structured · Portable**

## Current release candidate

**v1.48** is feature-frozen for release. It brings the document editor,
device-local Project navigation, strict import diagnostics, and the
Proofnote Editable HTML 2 round-trip protocol into one tested local-first
workflow. The regression suite covers document modelling, persistence,
cross-document identity, editable HTML reconciliation, and editor behaviour.
